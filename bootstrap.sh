...
apt-get install -y nginx libgdbm-dev libncurses5-dev automake libtool bison libffi-dev nginx-extras git libpq-dev nodejs g++ postgresql python-pip python-dev python-imaging
